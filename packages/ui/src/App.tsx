...
class App extends React.Component<any, any> {
  ...
  private sendTransaction = (_tx: any): Promise<string> =>
  ...
  public testOpenBox = async () => {
    function getBoxProfile(address: string, provider: any): Promise<IBoxProfile> {
      return new Promise((resolve, reject) => {
        openBox(address, provider, async () => {
              ...
              <SBalances>
                ...
                <Column center>
                  <STestButtonContainer>
                    ...
                    <STestButton left onClick={() => this.testContractCall(DAI_BALANCE_OF)}>
                      {DAI_BALANCE_OF}
                    </STestButton>

                    <STestButton left onClick={() => this.testContractCall(DAI_TRANSFER)}>
                      {DAI_TRANSFER}
                    </STestButton>
