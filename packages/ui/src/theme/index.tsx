...
function colors(darkMode: boolean): Colors {
  return {
    ...
    // backgrounds / greys
    bg0: darkMode ? '#0A0A0A' : '#FFF',
    bg1: darkMode ? '#1a1a1c' : '#F7F8FA',
    bg2: darkMode ? '#222222' : '#EDEEF2',
    bg3: darkMode ? '#40444F' : '#CED0D9',
    bg4: darkMode ? '#565A69' : '#888D9B',
    bg5: darkMode ? '#6C7284' : '#888D9B',
    bg6: darkMode ? '#C4C4C4' : '#6C7284',
    ...
    //primary colors
    primary1: darkMode ? '#C4C4C4' : '#15b7b9',
...
function theme(darkMode: boolean): DefaultTheme {
  return {
    ...
    //shadows
    shadow1: darkMode ? '#333' : '#2F80ED',
    defaultButtonRadius: DefaultButtonRadius,
    // media queries
...
export default function CustomziedThemeProvider({ children }: { children: React.ReactNode }) {
